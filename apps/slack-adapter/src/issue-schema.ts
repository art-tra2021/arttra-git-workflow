...
export const ISSUE_TEMPLATES: IssueTemplateSchema[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "parent", label: "親Intake", kind: "input", required: true },
  ...
  },
  {
    ...
    fields: [
      { id: "parent", label: "親Work / Business", kind: "input", required: true },
      { id: "action", label: "このPRで実装すること", kind: "textarea", required: true },
      { id: "done", label: "完了条件", kind: "textarea", required: true, initialValue: "- [ ] " },
      {
        id: "boundaries",
  ...
  },
  {
    ...
    labels: ["type/business", "status/todo"],
    fields: [
      { id: "parent", label: "親Intake", kind: "input", required: true },
